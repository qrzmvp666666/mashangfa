...
code = code.replace(/              <\/View>\s*<View style=\{styles\.modalFooter\}>/, uiCode);
...
if (!code.includes("statusOption:")) {
    code = code.replace(/    configSaveButtonText: \{ color: "\#fff", fontSize: 16, fontWeight: "600" \},/g, styleCode);
}
