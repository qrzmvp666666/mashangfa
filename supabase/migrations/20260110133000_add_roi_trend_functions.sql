-- New RPC functions to calculate ROI Trend instead of Signal Count Trend
-- Drop existing functions to avoid return type conflict if they exist
DROP FUNCTION IF EXISTS public.get_trader_roi_trend(uuid, integer);
DROP FUNCTION IF EXISTS public.get_multiple_traders_roi_trend(text[], integer);
